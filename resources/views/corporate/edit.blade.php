...
@section('content')
    <div class='row'>
        <div class='col-md-12'>
            <!-- Box -->
            {{ Form::model($corporate, ['route' => ['corporate.update', $corporate->id], 'class' => 'form-horizontal', 'method' => 'PATCH']) }}
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 {{ $errors->has('corporate_name') ? ' has-error' : '' }}">
                            {{ Form::text('corporate_name', null, ['class' => 'form-control', 'placeholder' => __('Name') ]) }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 {{ $errors->has('corporate_ID') ? ' has-error' : '' }}">
                            {{ Form::text('corporate_ID', null, ['class' => 'form-control', 'placeholder' => __('Corporate ID') ]) }}
