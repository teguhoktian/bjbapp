...
@section('content')
    <div class='row'>
        <div class='col-md-12'>
            <!-- Box -->
            {{ Form::model($office, ['route' => ['office.update', $office->id], 'class' => 'form-horizontal', 'method' => 'PATCH']) }}
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 {{ $errors->has('code') ? ' has-error' : '' }}">
                            {{ Form::text('code', null, ['class' => 'form-control', 'placeholder' => __('Office Code') ]) }}
