...
@section('content')
    <div class='row'>
        <div class='col-md-12'>
            <!-- Box -->
            {{ Form::model($quarter, ['route' => ['quarter.update', $quarter->id], 'class' => 'form-horizontal', 'method' => 'PATCH']) }}
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 {{ $errors->has('year') ? ' has-error' : '' }}">
                            {{ Form::text('year', null, ['class' => 'form-control', 'placeholder' => __('Quarter Year') ]) }}
